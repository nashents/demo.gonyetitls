...
class LoadingPointsExport implements  FromQuery,
ShouldAutoSize,
WithMapping,
WithHeadings,
WithEvents,
...
WithCustomStartCell
{
    ...
    */
    ...
    {
        return LoadingPoint::query();
    }
    public function map($loading_point): array{
            return   [
                $loading_point->name,
                $loading_point->lat,
                $loading_point->long,
                $loading_point->contact_name,
                $loading_point->contact_surname,
                $loading_point->email,
                $loading_point->phonenumber,
                 ];
