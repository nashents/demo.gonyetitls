            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="Product">Garage Bookings</label>
                                <select wire:model.debounce.300ms="booking_id" class="form-control">
                                    <option value="">Select Booking</option>
                                    @foreach ($bookings as $booking)
                                    <option value="{{$booking->id}}">{{$booking->booking_number}} {{$booking->service_type ? $booking->service_type->name : ""}} |
                                        @if ($booking->horse)
                                        {{$booking->horse ? $booking->horse->registration_number : ""}} {{$booking->horse ? "(".$booking->horse->fleet_number.")" : ""}} {{$booking->horse->horse_make ? $booking->horse->horse_make->name : ""}} {{$booking->horse->horse_model ? $booking->horse->horse_model->name : ""}} 
                                        @elseif ($booking->vehicle)
                                        {{$booking->vehicle ? $booking->vehicle->registration_number : ""}} {{$booking->vehicle ? "(".$booking->vehicle->fleet_number.")" : ""}} {{$booking->vehicle->vehicle_make ? $booking->vehicle->vehicle_make->name : ""}} {{$booking->vehicle->vehicle_model ? $booking->vehicle->vehicle_model->name : ""}} 
                                        @elseif ($booking->trailer)
                                        {{$booking->trailer ? $booking->trailer->registration_number : ""}} {{$booking->trailer ? "(".$booking->trailer->fleet_number.")" : ""}} {{$booking->trailer ? $booking->trailer->make : ""}} {{$booking->trailer ? $booking->trailer->model : ""}} 
                                        @endif
                                    </option>
                                    @endforeach
                                </select>
                                @error('booking_id') <span class="text-danger error">{{ $message }}</span>@enderror
                                {{-- <small>  <a href="{{ route('bookings.index') }}" target="_blank"><i class="fa fa-plus-square-o"></i> New Expense Category</a></small>  --}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="Product">Expense Accounts<span class="required" style="color: red">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select wire:model.debounce.300ms="product_id.0" class="form-control" required>
                                    ...
                                    <option value="{{$product->id}}">{{$product->product_number}} {{$product->brand ? $product->brand->name : ""}} {{$product->name}} {{$product->part_number}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" min="0.01" class="form-control" wire:model.debounce.300ms="rate.0"  placeholder="Price " required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="Product">Rate<span class="required" style="color: red">*</span></label>
                                    <input type="number" step="any" min="0.01" class="form-control" wire:model.debounce.300ms="rate.{{$value}}"  placeholder="Price " required>
