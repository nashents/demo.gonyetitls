                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <select wire:model.debounce.300ms="purchase_id" class="form-control" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model.debounce.300ms="serial_number" placeholder="Enter Product Serial Number" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control" wire:model.debounce.300ms="rate" placeholder="Enter Asset Amount">
