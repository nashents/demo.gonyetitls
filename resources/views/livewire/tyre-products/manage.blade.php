                            ...
                            <table id="productsTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="th-sm">Attributes
                                    </th>
                                    <th class="th-sm">Brand
                                    </th>
                                    <th class="th-sm">Name
                                    </th>
                                    <th class="th-sm">Manufacturer
                                    </th>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><img src="{{asset('images/uploads/'.$product->filename)}}" alt="" style="width: 45%; height:45%"></td>
                                    <td>{{$product->category_value ? $product->category_value->name : "undefined"}}</td>
                                    <td>@foreach ($product->product_attributes as $product_attribute)

                                        [{{$product_attribute->attribute ? $product_attribute->attribute->name : "undefined attribute"}} - {{$product_attribute->attribute_value ? $product_attribute->attribute_value->name : "undefined attribute value"}}],
