                    ...
                    <div class="panel">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="country">Category Types<span class="required" style="color: red">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="country">Attributes<span class="required" style="color: red">*</span></label>
                                       <select wire:model.debounce.300ms="selectedAttribute.0" class="form-control" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="country">Attribute Values<span class="required" style="color: red">*</span></label>
