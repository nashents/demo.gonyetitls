                            ...
                            <table id="productsTable" class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{$product->category_value ? $product->category_value->name : ""}}</td>
                                    <td>@foreach ($product->product_attributes as $product_attribute)

                                        [{{$product_attribute->attribute ? $product_attribute->attribute->name : " attribute"}} - {{$product_attribute->attribute_value ? $product_attribute->attribute_value->name : " attribute value"}}],
