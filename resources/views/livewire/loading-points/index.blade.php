                        ...
                        <div class="panel-body p-20"style="overflow-x:auto; width:100%; height:100%;">
                            ...
                            <table  class="table table-striped table-bordered table-sm table-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>{{ucfirst($loading_point->name)}}</td>
                                    <td>{{ucfirst($loading_point->contact_name)}} {{ucfirst($loading_point->contact_surname)}}</td>
                                    <td>{{ucfirst($loading_point->email)}}</td>
                                    <td>{{ucfirst($loading_point->phonenumber)}}</td>
                                    <td>
