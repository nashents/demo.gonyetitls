                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            {{-- <div class="panel-title" style="float: right">
                                <a href="{{route('top_ups.export.excel')}}"  class="btn btn-default"><i class="fa fa-download"></i>Excel</a>
                                <a href="{{route('top_ups.export.csv')}}"  class="btn btn-default"><i class="fa fa-download"></i>CSV</a>
                                <a href="{{route('top_ups.export.pdf')}}"  class="btn btn-default"><i class="fa fa-download"></i>PDF</a>
                                <a href="" data-toggle="modal" data-target="#top_upsImportModal" class="btn btn-default"><i class="fa fa-upload"></i>Import</a>
                            </div> --}}
                            <div class="panel-title">
                                <a href="" data-toggle="modal" data-target="#top_upModal" class="btn btn-default"><i class="fa fa-plus-square-o"></i>Fuel Supplier</a>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="supplier_id">Fuel Supplier</label>
                       <select wire:model.debounce.300ms="supplier_id" class="form-control" required>
