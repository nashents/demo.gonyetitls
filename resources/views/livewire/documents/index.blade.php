                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="{{ $rand }}"  wire:model.debounce.300ms="file" placeholder="Upload File" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" id="{{ $rand }}" class="form-control"  wire:model.debounce.300ms="file" placeholder="Upload File" >
                                @error('file') <span class="error" style="color:red">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
