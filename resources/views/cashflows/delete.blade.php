<div data-backdrop="static" data-keyboard="false" class="modal fade" id="cashflowDeleteModal{{ $cashflow->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-danger">
            <div class="modal-body">
               <center> <strong>Are you sure you want to delete this Transaction?</strong> </center> 
            </div>
            <form action="{{route('cashflows.destroy', $cashflow->id)}}" method="POST" >
                {{ csrf_field() }}
